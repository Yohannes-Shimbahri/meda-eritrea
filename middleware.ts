...
export async function middleware(request: NextRequest) {
  ...
  const csp = [
    ...
    "img-src 'self' data: blob: https://res.cloudinary.com https://lh3.googleusercontent.com https://*.supabase.co https://*.googleapis.com https://*.gstatic.com https://maps.gstatic.com https://*.google.com",    
