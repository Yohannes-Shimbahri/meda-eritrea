            ...
            {loadingData ? (
              ...
              <div style={{ gridColumn: '1 / -1', textAlign: 'center', padding: '4rem 1rem' }}>
                ...
                <p style={{ color: '#888', marginBottom: '1.5rem' }}>
                  {category ? `No businesses listed in this category yet.` : `Try adjusting your search or filters.`}
                </p>
                {category && (
                  <a href="/register/business" style={{ display: 'inline-block', backgroundColor: '#c9933a', color: '#0a0a0a', padding: '0.75rem 1.5rem', borderRadius: '0.75rem', fontWeight: '700', fontSize: '0.9rem', textDecoration: 'none' }}>
