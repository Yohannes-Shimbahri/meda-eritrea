...
const translations: Record<Language, any> = {
  en: {
    ...
    home: {
      ...
      hero_subtitle: 'Book appointments, browse services, and connect with your community, all in one place.',
  ...
  ti: {
    ...
    home: {
      ...
      hero_subtitle: 'ቆጸራ ሓዝ፣ አገልግሎታት ድለ፣ ምስ ማሕበረሰብካ ተራኸብ፣ ኩሉ ኣብ ሓደ ቦታ።',
